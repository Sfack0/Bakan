...
const menuDataGR ={
    "drinks": [
        ...
        {
            "name": "Feeju ice tea ροδάκινο",
            "type": "Τσάι",
            "category": "Παγωμένο",
            "price": "3.50",
        },
        {
            "name": "Feeju ice tea λεμόνι",
            "type": "Τσάι",
            "category": "Παγωμένο",
            "price": "3.50",
        },
        ...
        {
            "name": "Vanilla Ice Caramel",
            "type": "Special Ροφήματα",
            "category": "Κρύα",
            "price": "4.50",
        },
        {
            "name": "Full Chocolate Ice",
            "type": "Special Ροφήματα",
            "category": "Κρύα",
            "price": "4.50",
        },
        ...
        {
            "name": "Παγοπορτοκαλάδα",
            "type": "Χυμοί",
            "category": "",
            "price": "3.50",
        },
        {
            "name": "Κανελάδα ζεστή/κρύα",
            "type": "Χυμοί",
            "category": "",
            "price": "3.50",
        },
        ...
        {
            "name": "Schweppes soda/grapefruit",
            "type": "Αναψυκτικά",
            "category": "",
            "price": "3.20",
        },
    ...
    "food": [
        ...
        },
        {
            ...
            "category": "Ομελέτες",
            "price": "7.00",
            "description" : "γραβιέρα, gouda, edam, μανούρι, κρέμα αβοκάντο, ψωμί ολικής, ρόκα, ντοματίνια, βαλσάμικο",
            "type_info" : "σερβίρεται εώς τις 15:30",
            "category_info" : "όλες οι ομελέτες σερβίρονται με τηγανιτές πατάτες"
        },
        {
        ...
        },
        {
            ...
            "category": "Πρωινό",
            "price": "11.00",
            "description" : "Ομελέτα επιλογής (αλλαντικών/τυριών), τορτίγια, με γαλοπούλα, τυρι, ντομάτα, φιλαδέλφια, λόλα, σαλάτα, γραβίερα, pancakes",
            "type_info" : "σερβίρεται εώς τις 15:30"
        },
        {
            "name": "Πρωινό 2",
        ...
        },
        {
            ...
            "category": "",
            "price": "6.00",
            "description" : "φέτες ψωμί ολικής, τυρί κρέμα αβοκάντο, τηγανιτά αυγά, αλάτι, πιπέρι, σαλάτα με ρόκα, ντοματίνια, βαλσάμικο",
            "type_info" : "σερβίρεται εώς τις 15:00",
            "category_info" : "Όλα τα αυγά μας είναι φρέσκα ελευθέρας βοσκής"
        },
        {
            ...
            "category": "",
            "price": "6.00",
            "description" : "φέτες ψωμί ολικής, κρέμα αβοκάντο cheddar, μπέικον, τηγανιτά αυγά, αλάτι, πιπέρι, σαλάτα με ρόκα, ντοματίνια, βαλσάμικο",
            "type_info" : "σερβίρεται εώς τις 15:00",
            "category_info" : "Όλα τα αυγά μας είναι φρέσκα ελευθέρας βοσκής"
        },
        {
        ...
        },
        {
            ...
            "type": "Βάφλες",
            "category": "Γλυκές",
            "description": "μπανανα, μήλο, mix nuts, μέλι, κανέλα",
            "price": "7.00",
            "type_info" : "Παγωτο +1.50, Μπανανα +1.00"
        },
        {
...
const menuDataENG={
    "drinks": [
        ...
        {
            "name": "Feeju ice tea Peach",
            "type": "Tea",
            "category": "Cold",
            "price": "3.50"
        },
        {
            "name": "Feeju ice tea Lemon",
            "type": "Tea",
            "category": "Cold",
            "price": "3.50"
        },
        ...
        },
	{
        ...
        {
            "name": "Cinnamon Drink Hot/Cold",
            "type": "Juices",
            "category": "",
            "price": "3.50"
        },
        {
            "name": "Homemade Lemonades B Fresh",
            "type": "Juices",
    ...
    "food": [
        {
            ...
            "category": "Omelettes",
            "price": "6.00",
            "description": "bacon, turkey, Frankfurt sausage, whole wheat bread, mayonnaise, arugula, cherry tomatoes, balsamic",
            "type_info": "served until 15:30",
            "category_info": "all omelettes are served with fries"
        },
        {
            ...
            "category": "Omelettes",
            "price": "6.00",
            "description": "graviera, gouda, edam, manouri cheese, avocado cream, whole wheat bread, arugula, cherry tomatoes, balsamic",
            "type_info": "served until 15:30",
            "category_info": "all omelettes are served with fries"
        },
        {
            ...
            "category": "Omelettes",
            "price": "6.50",
            "description": "olives, manouri cheese, green pepper, sausage, oregano, whole wheat bread, arugula, cherry tomatoes, balsamic",
            "type_info": "served until 15:30",
            "category_info": "all omelettes are served with fries"
        },
        {
            ...
            "category": "Breakfast",
            "price": "9.00",
            "description": "Omelette of choice (cold cuts/cheese), tortilla with turkey, cheese, tomato, philadelphia, lollo lettuce, salad, graviera, pancakes",
            "type_info": "served until 15:30"
        },
        {
            "name": "Breakfast 2",
            ...
            "category": "Breakfast",
            "price": "9.00",
            "description": "Toast with cheese, turkey, toasted bread, fries, bacon-sausage rolls, cheese-turkey rolls, pancakes",
            "type_info": "served until 15:30"
        },
        {
        ...
        },
        {
            ...
            "category": "Breakfast",
            "price": "9.00",
            "description": "whole wheat bread slices with peanut butter, honey, and banana, tortilla with turkey, cheese, Philadelphia, tomato, lollo lettuce",
            "type_info": "served until 15:30"
        },
        {
            "name": "Power Bowl",
            ...
            "category": "Breakfast",
            "price": "6.50",
            "description": "cream cheese, yogurt, honey, seasonal fruits, oat flakes, superfood mix",
            "type_info": "served until 15:30"
        },
        {
            "name": "Cold Cuts",
            ...
            "category": "",
            "price": "5.50",
            "description": "whole wheat bread slices, cheese, turkey, bacon, avocado cream, fried eggs, salt, pepper, salad with arugula, cherry tomatoes, balsamic",
            "type_info": "served until 15:00",
            "category_info": "All our eggs are fresh and free-range"
        },
        {
            "name": "Vegeterian",
            "type": "Egg Tower",
            "category": "",
            "price": "5.50",
            "description": "whole wheat bread slices, avocado cream cheese, fried eggs, salt, pepper, salad with arugula, cherry tomatoes, balsamic",
            "type_info": "served until 15:00",
            "category_info": "All our eggs are fresh and free-range"
        },
        {
            ...
            "category": "",
            "price": "6.00",
            "description": "whole wheat bread slices, avocado cheddar cream, bacon, fried eggs, salt, pepper, salad with arugula, cherry tomatoes, balsamic",
            "type_info": "served until 15:00",
            "category_info": "All our eggs are fresh and free-range"
        },
        {
            ...
            "category": "Club Sandwiches",
            "price": "5.50",
            "description": "cheese, turkey, bacon, mayonnaise, lollo lettuce, tomato, fries"
        },
        {
            "name": "Chicken",
            "type": "All Day",
            "category": "Club Sandwiches",
            "price": "6.00",
            "description": "cheese, chicken fillets, bacon, mixed chicken sauce, lollo lettuce, tomato, fries"
        },
        {
            "name": "Barbeque",
            "type": "All Day",
            "category": "Burgers",
            "price": "8.50",
            "description": "brioche bun, 100% beef patty 200g, bacon, golden BBQ sauce, cheddar, caramelized onions, lollo lettuce, tomato, fries"
        },
        {
            "name": "Chicken",
            "type": "All Day",
            "category": "Burgers",
            "price": "7.50",
            "description": "brioche bun, breaded chicken fillet, mayonnaise, cheddar, lollo lettuce, tomato, fries"
        },
        {
            "name": "Special",
            "type": "All Day",
            "category": "Burgers",
            "price": "9.00",
            "description": "brioche bun, 100% beef patty 200g, omelette, bacon, golden BBQ sauce, cheddar, caramelized onions, lollo lettuce, tomato, fries"
        },
        {
